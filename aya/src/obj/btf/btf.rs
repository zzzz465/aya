...
use crate::{
    generated::{
        btf_enum, btf_ext_header, btf_func_linkage, btf_header, btf_member,
    },
...
#[cfg(test)]
mod tests {
    use crate::generated::{btf_param, BTF_INT_SIGNED, BTF_VAR_STATIC, btf_var_secinfo};
